        ...
        <main className="flex lg:h-[100vh] justify-center">
            <div className="w-full lg:w-[60%] p-8 md:p-14 flex items-center justify-center">
                <div className="p-8 w-[600px]">
                    ...
                    <div className="bg-black/[0.05] text-white w-64 py-4 mt-10 rounded-full transition-transform hover:bg-black/[0.8] active:scale-90 flex justify-center items-center gap-4 cursor-pointer group">
                        <FcGoogle size={22} />
                        <span
